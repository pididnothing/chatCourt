        ...
        <div>
            ...
            <dialog id="profile-modal" className="modal flex items-center justify-center flex-col gap-1">
                ...
                <fieldset className="fieldset 2xl:w-3xl md:w-md sm:w-2xs bg-base-300 border-0 p-4 rounded-box">
                    ...
                    <h2 className='text-xl w-full bg-base-300 border-0 transition duration-500 hover:-translate-y-0.5 hover:drop-shadow-lg text-base-200 p-1 rounded-box'>Id:{user._id}</h2>
                </fieldset>
            </dialog>
        </div>
    )
